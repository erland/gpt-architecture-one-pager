...
def build(root:Path,version:str,target:Path)->dict:
    ...
    cmds=[["scripts/build_distributions.py","--version",version],["scripts/build_peer_distributions.py","--version",version],["scripts/build_project_package.py","--version",version],["scripts/build_delivery_metadata.py","--version",version]]
    for cmd in cmds:
